    ...
    <div className={`bg-white dark:bg-gray-900 rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow border ${
      ...
      <div className="relative h-48 overflow-hidden">
        ...
        <div className="absolute top-4 left-4">
          {!isAnnualMagazine && (
            <span className="inline-block py-1 px-3 text-xs font-medium bg-theme-blue text-white rounded-full">
              {category}
            </span>
          )}
        </div>
