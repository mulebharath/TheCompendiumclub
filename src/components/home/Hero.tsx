      ...
      >
        <div className="animate-reveal">
          ...
          <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl leading-relaxed md:leading-relaxed animate-fade-in-delayed">
            Club of Compendium is a platform for students to showcase their writing talents, research papers, and creative works while developing professional publication skills.
          </p>
