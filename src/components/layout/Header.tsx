    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        >
          ...
          <span className={cn(
            "font-serif text-2xl font-bold tracking-tighter transition-all duration-300 group-hover:text-primary",
            isHomePage ? "text-theme-blue dark:text-white" : "text-white dark:text-white"
          )}>
            The Compendium
          </span>
        ...
        <nav className="hidden md:flex items-center space-x-8">
          {navLinks.map((link) => (
            <Link
              ...
              to={link.path}
              className={cn(
                "nav-link text-sm font-medium transition-colors duration-300 hover:text-primary relative py-2",
                isHomePage ? "text-theme-blue dark:text-white" : "text-white dark:text-white",
